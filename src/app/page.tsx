...
const trustIcons = [
  ...
  <svg key="heart" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" /></svg>,
  <svg key="cog" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>,
  <svg key="users" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg>,
]

const achievementIcons = [
  <svg key="a1" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" /></svg>,
  <svg key="a2" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" /></svg>,
  <svg key="a3" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg>,
  <svg key="a4" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" /></svg>,
]
        ...
        <div className="max-w-container mx-auto px-4 md:px-6 py-5 md:py-20 relative z-10 w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-5 md:gap-16">
            ...
            >
              <div className="relative mx-auto w-[220px] sm:w-[260px] md:w-full">
                ...
                <div className="h-[260px] sm:h-[300px] md:h-auto md:aspect-[3/4] rounded-2xl md:rounded-3xl relative overflow-hidden border-2 border-primary/10 bg-gradient-to-br from-primary/5 to-surface">
                  ...
                  <div className="absolute bottom-3 right-3 md:bottom-4 md:right-4 opacity-30">
                    <BJPLotus size={28} animate={false} />
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <div className="flex-[3] text-center md:text-left order-2 md:order-1">
              ...
              >
                <AnimatedHeroText
                  staticText={t.hero.headline.split('.')[0] + '.'}
                  rotatingWords={t.hero.headline.split('.').slice(1).map(s => s.trim()).filter(Boolean).map(s => s + '.')}
                  className="text-[28px] sm:text-4xl md:text-5xl lg:text-[52px] font-extrabold text-text leading-[1.1] mb-3 md:mb-6"
                  interval={2200}
                />
              </motion.div>
              ...
              <motion.p
                ...
                className="text-sm md:text-lg lg:text-xl text-muted leading-relaxed mb-5 md:mb-10 max-w-lg mx-auto md:mx-0"
              >
                {t.hero.subtext}
              </motion.p>
              ...
              <motion.div
                ...
                className="flex flex-row gap-2 md:gap-4 justify-center md:justify-start"
              >
                <Link
                  href="/pugaar-petti"
                  className="group bg-gradient-to-r from-primary to-[#FF8533] text-white font-bold px-5 py-2.5 md:px-8 md:py-4 text-sm md:text-base rounded-full hover:shadow-xl hover:shadow-primary/25 hover:scale-[1.02] transition-all text-center inline-flex items-center justify-center gap-2"
                >
                  {t.hero.cta1}
                  <svg className="w-3.5 h-3.5 md:w-4 md:h-4 group-hover:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
          ...
          <div className="max-w-container mx-auto px-4 md:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-14">
              ...
              <div className="w-full md:w-7/12">
                <h2 className="text-2xl sm:text-3xl md:text-[40px] font-extrabold text-text mb-6 md:mb-10 leading-tight">
                  {t.whoIAm.header}
                </h2>
                  ...
                  {[t.whoIAm.point1, t.whoIAm.point2, t.whoIAm.point3, (t.whoIAm as Record<string, string>).point4, (t.whoIAm as Record<string, string>).point5].filter(Boolean).map((point, i) => (
                    <StaggerItem key={i}>
                      <div className="flex items-start gap-4 p-4 rounded-2xl hover:bg-surface transition-colors group">
                        ...
                        <p className="text-lg text-muted leading-relaxed pt-1.5">{point}</p>
                      </div>
                    </StaggerItem>
                  ))}
                </StaggerContainer>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <FadeInSection>
          <div className="max-w-container mx-auto px-6 text-center relative z-10">
            <h2 className="text-2xl sm:text-3xl md:text-[44px] font-extrabold text-white mb-4 leading-tight">
              {t.ctaBanner.header}
            </h2>
